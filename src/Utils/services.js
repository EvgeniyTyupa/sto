...
export const services = [
    ...
    },
    {
        ...
        headerPoints: "Основные признаки поломки МКПП:",
        points: [
            ...
            "На холостом ходу появляется стук, скрежет и гул, передающиеся на рычаг переключения передач;",
            "При движении машины ощущается шум, гул, скрежет;"
        ],
        headerFactor: "При диагностике и ремонте механической коробки передач мы проверяем:",
        factors: [
            "целостность корпуса;",
            "наличие подтеков трансмиссионного масла;",
            "присутствие посторонних шумов в коробке;",
            "уровень масла;",
            "работоспособность подшипников;",
            "выработку оси и шестерней сателлитов",
            "состояние синхронизаторов и вилок выбора передач;",
            "состояние шестерен и валов;",
            "герметичность и износ сальников."
        ],
        dop: [
            "На нашем автосервисе процесс ремонта и сборки МКПП проходит быстро. Мы проводим комплекс процедур по снятию, разборке МКПП и чистке коробки передач с последующим определением дефектов, в ходе которого точно выявляются все неисправности.",
            "После определения всех проблемных мест и подбора новых запчастей, мы очень быстро и качественно восстанавливаем целостность узла, собираем и устанавливаем агрегат МКПП на свое место. Если у Вас нет возможности находится при дефектовке МКПП, мы с нашей стороны предоставляем фото и видео, чтобы Вы наглядно ознакомились с неисправностями вашей коробки передач."
        ],
        works: []
    },
    {
